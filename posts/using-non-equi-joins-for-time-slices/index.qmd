...
This is an updated version of this blog-post from 2025-12-27.
:::
...
We can see, that the foverlaps-function and the non-equi-join-function needed more or less the same time with the microbenchmark-package. To better see the differences, we can use the profvis package (by the way: the `setkeyv` used up more time than the joining operations).
