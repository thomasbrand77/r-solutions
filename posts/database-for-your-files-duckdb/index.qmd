...
# close DB
dbDisconnect(example_con)


```

To do this we have to attach our example-database

```{r}
#| label: view to other database
...
# with this you can access the iris table
i = dbGetQuery(con, "
           SELECT *
...
Our created views are permanet, but unfortunately not the attachment. For this you have to have attach it manually or create a function that does this for all your databases
...
::: callout-note
To avoid naming conflicts I would add a prefix of the package-name for the table names, i.e. \<package-name\>.<table-name>
:::
